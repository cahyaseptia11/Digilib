...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="i#" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">ADIGITAL LIBRARY</span>
    </a>
        ...
        <form class="form-horizontal" action="update_buku.php" method="POST">
          <div class="card-body">
            <!-- <div class="form-group row">                    
              ...
              <input type="hidden" class="form-control" id="id_buku" placeholder="ID Buku" name="idbuku" value="<?php echo $d['idbuku'];?>">
            <div class="form-group row">
