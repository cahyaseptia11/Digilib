  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">CAHYA SEPTIA</a>
        </div>
      </div>
    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          ...
          <a href="input_transaksi.php"><button type="submit" class="btn btn-primary">Transaksi Baru</button></a>      
        </div>
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            ?>        
            <!-- SELECT tb_transaksi.idtransaksi,tb_anggota.idanggota,tb_anggota.nama,tb_buku.idbuku,tb_buku.judulbuku,tb_transaksi.tglpeminjaman,tb_transaksi.tglpengembalian FROM tb_transaksi JOIN tb_anggota ON tb_transaksi.idanggota = tb_anggota.idanggota JOIN tb_buku ON tb_transaksi.idbuku = tb_buku.idbuku; -->
                  <tr>
...
<script>
  $(function () {
    $("#example1").DataTable({
      ...
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis", "copy"]
